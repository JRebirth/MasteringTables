...
public class ArcadeButtonSkin extends ToggleButtonSkin implements Skin<ToggleButton> {
     ...
     */
    public ArcadeButtonSkin(final ToggleButton toggleButton) {
        super(toggleButton);
        ...
        final Circle circle1 = CircleBuilder.create()
        ...
        final Circle circle2 = CircleBuilder.create()
        ...
        final Circle circle3 = CircleBuilder.create()
                .fill(Color.BLACK)
        ...
        // </effect>
        // * </Circle>
        final Circle circle4 = CircleBuilder.create().build();
        final Circle circle5 = CircleBuilder.create().build();
